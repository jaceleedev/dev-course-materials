...
### 🧮 [계산기 만들기](/projects/level-1/calculator)

연산자를 활용하여 기본 계산 기능을 수행하는 계산기를 만들어보세요. 산술, 비교, 대입 연산자를 모두 활용할 수 있는 실용적인 프로젝트입니다.

- **주요 학습 내용**: 산술 연산자, 타입 변환, 사용자 입력 처리
...
키와 몸무게를 입력받아 BMI를 계산하는 프로그램을 만들어보세요.

### 과제 2: 학점 계산기

여러 과목의 점수를 입력받아 평균을 계산하는 프로그램을 만들어보세요.

### 과제 3: 시간 계산기

초를 입력받아 시, 분, 초로 변환하는 프로그램을 만들어보세요.
